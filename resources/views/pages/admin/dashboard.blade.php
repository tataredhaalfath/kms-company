...
@section('content')
    ...
    <div class="page-content" style="min-height: 80vh!important;">
        <section class="row">
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">File Gambar</h6>
                        ...
                        <div class="card">
                            <div class="card-body px-4 py-4-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                        <h6 class="text-muted font-semibold">Testimoni Pelanggan</h6>
                    ...
                    <div class="card-body py-4 px-4">
                        <div class="d-flex align-items-center">
                            <div class="avatar avatar-xl">
                                ...
                                <img src="{{ Storage::url(Auth::user()->profile) }}" alt="profile">
                                @else
                                <img src="{{ asset('dashboard/assets/images/faces/1.jpg') }}" alt="profile">
                                @endif
                            </div>
                            <div class="ms-3 name">
